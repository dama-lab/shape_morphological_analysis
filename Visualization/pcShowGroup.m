function [fig,axs] = pcShowGroup(targetLists, groups, volDir, maskDir, colorLim, bg_color, iso2meshOpt, labelRemapTable, labelsToRemap, bgLabel)
    %%
...
%             %pc = pcdownsample(pc,'random',0.5);    
            ...
            pc = vol2pc(vol, mask, bgLabel, iso2meshOpt);
